...
--
-- Instruções: Copie todo este conteúdo, vá no seu painel do Supabase, 
-- clique em "SQL Editor", crie uma "New Query", cole e execute (Run).
-- ====================================================================
...
-- ====================================================================
-- Este trigger escuta novos usuários no módulo de autenticação do Supabase
-- e automaticamente cria uma linha na tabela pública "perfis" com o nome
-- e perfil enviados nos metadados do cadastro.
-- ====================================================================
